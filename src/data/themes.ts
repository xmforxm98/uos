...
export const themes: BrandTheme[] = [
  ...
  },
  {
    id: 'brand-b',
    name: 'Brand B',
    description: 'Purple-first, very rounded — playful, consumer-facing, modern SaaS. Maximum radius.',
    accentColor: '#9333ea',
    overrides: [
      ...
      { semanticId: 'border/brand',        primitiveRef: 'purple-500', value: '#a855f7' },
      ...
      { semanticId: 'interactive/active',  primitiveRef: 'purple-800', value: '#6b21a8' },
      { semanticId: 'interactive/focus',   primitiveRef: 'purple-400', value: '#c084fc' },
      ...RADIUS_ROUNDED,
    ],
  },
]
